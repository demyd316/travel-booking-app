...
// import 'package:myapp/ChooseAdventure1.dart';

class ChooseAdventure extends StatefulWidget {
  @override
  _ChooseAdventureState createState() => _ChooseAdventureState();
}

class _ChooseAdventureState extends State<ChooseAdventure> {
  bool detailsVisible;
  @override
  void initState() {
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => StandardadventureSummary()),
                        );
                      },
                    ),
                  ),
