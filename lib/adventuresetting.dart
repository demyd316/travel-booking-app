...
class AdventureSetting extends StatefulWidget {
  @override
  _AdventureSettingState createState() => _AdventureSettingState();
}

class _AdventureSettingState extends State<AdventureSetting> {
  Widget _backButton() {
    return InkWell(
      onTap: () {
