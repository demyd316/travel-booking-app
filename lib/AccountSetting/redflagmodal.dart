...
import 'flagcanceltripmodal.dart';

class RedflagModal extends StatefulWidget {
  @override
  _RedflagModalState createState() => _RedflagModalState();
}

class _RedflagModalState extends State<RedflagModal> {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                showDialog(
                  context: context,
                  builder: (context) => FlagcanceltripModal(),
                );
              },
              child: Text(
                'I need to end my trip!',
