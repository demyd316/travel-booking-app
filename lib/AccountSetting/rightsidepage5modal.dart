...
class Rightsidepage5Modal extends StatefulWidget {
  @override
  _Rightsidepage5ModalState createState() => _Rightsidepage5ModalState();
}

class _Rightsidepage5ModalState extends State<Rightsidepage5Modal> {
